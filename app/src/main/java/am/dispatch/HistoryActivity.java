...
import am.dispatch.adapter.HistoryAdapter;
import am.dispatch.model.History;
...
//        install_apk = findViewById(R.id.install_apk);
    ...
    public void GET(String device_id) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "https://art.artisticmilliners.com:8081/ords/art/bscan/dispatch_history/?device_id=" + device_id, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.e("response", response.toString());
                try {
                    JSONArray obj = response.getJSONArray("items");
                    Log.e("obj", String.valueOf(obj.length()<0));
                    if(!obj.isNull(0)){
                        Log.e("obj13166", String.valueOf(obj.length()<0));
                        ...
                        ErrorcustomdialogNOData("Record not found", "Alert");
                    }
    ...
    public void ErrorcustomdialogNOData(String msg, String timeout) {
        final Dialog dialog = new Dialog(HistoryActivity.this);
        dialog.setContentView(R.layout.error_dialogbox);
        Button dialogButton = (Button) dialog.findViewById(R.id.buttonOk);
        TextView error_heading = (TextView) dialog.findViewById(R.id.error_heading);
